...
<node CREATED="1529215265547" ID="ID_1997729079" MODIFIED="1529216025341" TEXT="localhost ansible_connect=local&#xa;51reboot ansible_connect=smart ansible_host=&quot;xxx.xxx.xxx.xxx&quot; ansible_port=22 ansible_user=&quot;silence&quot; ansible_become_user=&quot;root&quot; ansible_python_interpreter=&quot;/bin/env python2.6&quot;"/>
</node>
</node>
...
<node CREATED="1529216177743" ID="ID_252833532" MODIFIED="1529216190369" TEXT="ansible 51reboot -m command -a &quot;sleep 30&quot; -i hosts_v2.yaml"/>
<node CREATED="1529216081975" ID="ID_1535834641" MODIFIED="1529216082891" TEXT="ansible 51reboot -m command -a &quot;sleep 30&quot; --become --ask-become-pass -i hosts_v2.yaml"/>
</node>
</node>
...
<node CREATED="1529217914752" ID="ID_97738663" MODIFIED="1529217945747" TEXT="host_vars/51reboot.yml"/>
</node>
...
<node CREATED="1529218657611" ID="ID_493655755" MODIFIED="1529218659026" TEXT="localhost ansible_connect=local&#xa;51reboot ansible_host=&quot;xxx.xxx.xxx.xxx&quot; ansible_user=&quot;silence&quot; ansible_become_user=&quot;root&quot; ansible_python_interpreter=&quot;/bin/env python2.6&quot;"/>
</node>
</node>
...
<node CREATED="1529219329374" ID="ID_1785857127" MODIFIED="1529219337432" TEXT="ansible 51reboot -m command -a &apos;echo ${TEST}&apos; -i hosts"/>
</node>
</node>
...
<node CREATED="1529219327189" ID="ID_1977705093" MODIFIED="1529219327595" TEXT="ansible 51reboot -m shell -a &apos;echo ${TEST}&apos; -i hosts"/>
</node>
</node>
...
<node CREATED="1529226834453" ID="ID_1873503751" MODIFIED="1529226837380" TEXT="ansible 51reboot -m raw -a&apos;echo `date` &gt; /tmp/current &apos; -i hosts"/>
</node>
</node>
...
<node CREATED="1529219669620" ID="ID_146247165" MODIFIED="1529325490894" TEXT="ansible 51reboot -m copy -a &apos;src=/etc/hosts dest=/tmp/hosts&apos; -i hosts">
<node CREATED="1529220141565" ID="ID_1420656141" MODIFIED="1529220145216" TEXT="&#x590d;&#x5236;&#x6587;&#x4ef6;"/>
</node>
<node CREATED="1529219780759" ID="ID_1525714115" MODIFIED="1529325490894" TEXT="ansible 51reboot -m copy -a &apos;src=/etc/profile.d/ dest=/tmp/profile.d/&apos;">
...
<node CREATED="1529220137410" ID="ID_1051456490" MODIFIED="1529325490909" TEXT="ansible 51reboot -m file -a &apos;dest=/tmp/hosts mode=777 owner=root group=root&apos; -i hosts --become --ask-become-pass">
<node CREATED="1529220150055" ID="ID_544629026" MODIFIED="1529220155006" TEXT="&#x4fee;&#x6539;&#x6587;&#x4ef6;&#x6743;&#x9650;"/>
</node>
<node CREATED="1529220279322" ID="ID_935210446" MODIFIED="1529325490909" TEXT="51reboot -m file -a &apos;dest=/tmp/kk/01/ mode=777 owner=silence group=silence state=directory&apos; -i hosts">
<node CREATED="1529220324084" ID="ID_1781602948" MODIFIED="1529220326698" TEXT="&#x521b;&#x5efa;&#x6587;&#x4ef6;&#x5939;"/>
</node>
<node CREATED="1529220280779" ID="ID_1913868678" MODIFIED="1529325490909" STYLE="fork" TEXT="ansible 51reboot -m file -a &apos;dest=/tmp/kk state=absent&apos; -i hosts">
...
<node CREATED="1529223901434" ID="ID_83463919" MODIFIED="1529325490909" TEXT="ansible 51reboot -m yum -a &apos;name=tree state=latest&apos; -i hosts --become --ask-become-pass">
<node CREATED="1529223946314" ID="ID_749131532" MODIFIED="1529223959456" TEXT="&#x5b89;&#x88c5;&#x5230;&#x6700;&#x65b0;&#x5305;"/>
</node>
<node CREATED="1529223905647" ID="ID_93683433" MODIFIED="1529325490909" TEXT="ansible 51reboot -m yum -a &apos;name=tree state=absent&apos; -i hosts --become --ask-become-pass">
<node CREATED="1529223940662" ID="ID_1332503623" MODIFIED="1529223944605" TEXT="&#x5378;&#x8f7d;&#x5305;"/>
</node>
<node CREATED="1529224028538" ID="ID_577454205" MODIFIED="1529325490909" TEXT="ansible 51reboot -m yum -a &apos;name=tree state=present&apos; -i hosts --become --ask-become-pass">
<node CREATED="1529224146873" ID="ID_1277612941" MODIFIED="1529224149827" TEXT="&#x5b89;&#x88c5;&#x5b89;&#x88c5;&#x5305;"/>
</node>
<node CREATED="1529224029889" ID="ID_368112004" MODIFIED="1529325490909" TEXT="ansible 51reboot -m yum -a &apos;name=tree-1.5.3 state=present&apos; -i hosts --become --ask-become-pass">
...
<node CREATED="1529225029816" ID="ID_449513307" MODIFIED="1529325490909" TEXT="ansible 51reboot -m user -a &apos;name=kk password=&lt;password&gt;&apos;  -i hosts --become --ask-become-pass">
<node CREATED="1529225173444" ID="ID_793251379" MODIFIED="1529225242618" TEXT="&#x521b;&#x5efa;&#x7528;&#x6237;/&#x4fee;&#x6539;&#x5bc6;&#x7801;"/>
</node>
<node CREATED="1528950401963" ID="ID_1916365216" MODIFIED="1529325490909" TEXT="ansible 51reboot -m user -a &apos;name=kk state=absent&apos;  -i hosts --become --ask-become-pass">
...
<node CREATED="1529225451788" ID="ID_299788807" MODIFIED="1529325490925" STYLE="fork" TEXT="ansible 51reboot -m git -a&apos;repo=https://github.com/imsilence/asynctask.git dest=/tmp/asynctask/ version=HEAD&apos; -i hosts">
...
<node CREATED="1529224376195" ID="ID_296439846" MODIFIED="1529325490925" TEXT="ansible 51reboot -m service -a &apos;name=nginx state=started&apos; -i hosts --become --ask-become-pass">
<node CREATED="1529224407761" ID="ID_643766605" MODIFIED="1529224409898" TEXT="&#x542f;&#x52a8;&#x670d;&#x52a1;"/>
</node>
<node CREATED="1529224365794" ID="ID_1455024203" MODIFIED="1529325490925" TEXT="ansible 51reboot -m service -a &apos;name=nginx state=stopped&apos; -i hosts --become --ask-become-pass">
<node CREATED="1529224410987" ID="ID_1310477824" MODIFIED="1529224419451" TEXT="&#x505c;&#x6b62;&#x670d;&#x52a1;"/>
</node>
<node CREATED="1529224378667" ID="ID_1783531818" MODIFIED="1529325490925" TEXT="ansible 51reboot -m service -a &apos;name=nginx state=restarted&apos; -i hosts --become --ask-become-pass">
...
<node CREATED="1529224203785" ID="ID_350751410" MODIFIED="1529224247907" TEXT="ansible 51reboot -m setup -i hosts"/>
</node>
</node>
...
<node CREATED="1529227085666" ID="ID_661214838" MODIFIED="1529227088143" TEXT="ansible 51reboot -m command -B 300 -P 0 -a &apos;sleep 60&apos; -i hosts"/>
<node CREATED="1529227148680" ID="ID_1321147851" MODIFIED="1529325490925" TEXT="ansible 51reboot -m command -B 300 -P 0 -a &apos;sleep 60&apos; -i hosts -vvvv | grep job">
<node CREATED="1529227151945" ID="ID_1875327322" MODIFIED="1529227196002" TEXT="&#x901a;&#x8fc7;-vvvv&#x83b7;&#x53d6;&#x8c03;&#x8bd5;&#x65e5;&#x5fd7;&#x8fc7;&#x6ee4;job"/>
</node>
<node CREATED="1529227200606" ID="ID_1942156876" MODIFIED="1529325490925" TEXT="ansible 51reboot -m async_status -a &apos;jid=557725439653.20928&apos; -i hosts">
...
<node CREATED="1529303582520" ID="ID_782067567" MODIFIED="1529303596793" TEXT="ansible 51reboot -m setup -i hosts -a &quot;filter=ansible_local&quot;"/>
